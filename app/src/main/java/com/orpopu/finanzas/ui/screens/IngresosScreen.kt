...
import com.orpopu.finanzas.viewmodel.IngresosViewModel

@Composable
fun IngresosScreen(onNavigate: (String) -> Unit) {
    ...
    Column(
        ...
        Text(
            text = "Registra y revisa tus ingresos mensuales.",
            style = MaterialTheme.typography.bodyLarge
        )
        Text(
            text = "Total ingresos: ${uiState.value.totalIngresos}",
